          ...
          {policies.map((policy, index) => {
            ...
            return (
              <motion.div
                ...
                className="min-w-0 rounded-[1.5rem] border border-slate-200 bg-white p-5 shadow-sm transition hover:-translate-y-0.5 hover:shadow-lg dark:border-slate-800 dark:bg-slate-900/80"
              >
